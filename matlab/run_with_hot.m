...
if sr_control
  ...
  is_5min_gp = 1;
  ptr.scenario_ptr.scenario.SplitRatioSet = compute_5min_splits_from_sim(ptr, gp_out, is_5min_gp, 0:(destination_commodities+2));
...
tic
[GP_V, GP_F, GP_D, HOV_V, HOV_F, HOV_D, ORD, ORF, FRD, FRF, ORQ, ORS] = extract_hot_simulation_data(ptr,xlsx_file,range,no_ml_queue,ORS,destination_commodities,orgf2,orgf3,orgf4);
disp(['Done in ' num2str(toc) ' seconds.']); 
