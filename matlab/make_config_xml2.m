...
or_id(1) = gp_id(1);
write_demand_set_xml3(fid,sr_control, xlsx_file, range, or_id, ORS, destination_commodities, orgf2, orgf3, orgf4, warmup_time);

[nodes, gates] = write_sr_set_xml2(fid, xlsx_file, range, gp_id, hov_id, or_id, fr_id, ORS, hot_offramps, destination_commodities, warmup_time);

if destination_commodities > 0
  write_commodity_controller_set(fid, xlsx_file, range, gp_id, hov_id, fr_id, nodes, gates);
end
